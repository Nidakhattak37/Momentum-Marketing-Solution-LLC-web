    ...
    <div id="contact-section" className="w-full py-24 animate-in fade-in duration-1000 px-6 bg-transparent">
      <div className="max-w-[1000px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2">
              ...
              <span className="text-[8px] font-bold text-zinc-700 tracking-[0.4em] uppercase">SYNC PROTOCOL</span>
            </div>
            ...
            <p className="text-zinc-600 text-[11px] font-semibold leading-relaxed max-w-xs uppercase tracking-wider">
        ...
        <div className="lg:col-span-7 relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-white/5 to-white/0 rounded-3xl blur-md opacity-10 transition duration-1000"></div>
          <div className="relative bg-[#020202] border border-white/10 rounded-2xl p-8 lg:p-10 shadow-[0_40px_100px_rgba(0,0,0,1)] overflow-hidden backdrop-blur-3xl">
            {submitted ? (
              <div className="min-h-[300px] flex flex-col items-center justify-center text-center animate-in zoom-in duration-500">
                ...
                <p className="text-zinc-700 text-[10px] uppercase font-black tracking-widest">Awaiting system response.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent border-b border-white/5 py-2 text-xs font-bold text-white focus:border-white/20 outline-none transition-all placeholder:text-zinc-900"
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-transparent border border-white/5 rounded-lg p-3 text-xs font-bold text-white focus:border-white/10 outline-none transition-all resize-none placeholder:text-zinc-900"
