...
const WhatWeDo: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 py-20 animate-in fade-in duration-700">
      <div className="mb-20">
        <h1 className="text-6xl font-black uppercase italic tracking-tighter text-white mb-6">
          Beyond <br /> Marketing
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        {steps.map((step, i) => (
          <div key={i} className="relative group p-10 bg-zinc-900/30 border border-zinc-800 rounded-[3rem] hover:border-zinc-700 transition-all">
            ...
            <h3 className="text-2xl font-black text-white uppercase italic mt-4 mb-4">{step.title}</h3>
      ...
      <div className="mt-24 p-12 bg-white text-black rounded-[3rem] flex flex-col md:flex-row items-center justify-between gap-8">
        <h2 className="text-3xl font-black uppercase italic tracking-tighter">Ready to redefine your creative workflow?</h2>
