...
const WhyMomentum: React.FC = () => {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-10 md:px-20 lg:px-40 py-24 animate-in fade-in duration-1000 overflow-hidden">
      ...
      <div className="mb-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-10 animate-in slide-in-from-left-8 duration-1000">
           ...
           <h1 className="text-4xl md:text-5xl lg:text-7xl font-black uppercase tracking-[0.15em] text-white leading-tight">
             BEYOND THE <br />
           ...
           <div className="space-y-6">
              ...
              <div className="flex gap-4">
                 <div className="flex flex-col gap-1 p-4 bg-white/5 rounded-2xl border border-white/5 min-w-[140px]">
                    <span className="text-xs font-black text-cyan-400 uppercase tracking-widest">Latency</span>
                    <span className="text-2xl font-black text-white">&lt; 150ms</span>
                 </div>
                 <div className="flex flex-col gap-1 p-4 bg-white/5 rounded-2xl border border-white/5 min-w-[140px]">
                    <span className="text-xs font-black text-purple-400 uppercase tracking-widest">Uptime</span>
        ...
        <div className="relative h-[400px] w-full bg-[#0a0a0c]/40 border border-white/5 rounded-[3rem] p-8 backdrop-blur-3xl overflow-hidden group animate-in slide-in-from-right-8 duration-1000">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
               <div className="flex justify-between items-start">
                  <div className="space-y-1">
                     <span className="text-[10px] font-black text-zinc-700 uppercase tracking-widest">Real-Time Ops</span>
                     <div className="text-xl font-bold text-white tracking-[0.2em] uppercase">SYSTEM ANALYTICS</div>
                  </div>
               ...
               <div className="flex-1 flex items-center justify-center">
                  <div className="relative">
                     <div className="w-48 h-48 rounded-full border border-dashed border-white/20 animate-spin-slow" />
                     <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-32 h-32 rounded-full bg-gradient-to-br from-cyan-400/20 to-purple-500/20 backdrop-blur-xl flex items-center justify-center border border-white/10 group-hover:scale-110 transition-transform duration-700">
               ...
               <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/5">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="space-y-1">
                       ...
                       <span className="text-[7px] font-black text-zinc-800 uppercase tracking-[0.2em]">Node_{i} active</span>
                    </div>
                  ))}
               </div>
            </div>
      ...
      {/* Grid Pillars */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-32 relative">
        {pillars.map((pillar, i) => (
          <div 
            key={i}
            className="group relative p-12 bg-[#0a0a0c]/40 border border-white/5 rounded-[3rem] hover:bg-[#0a0a0c]/80 hover:border-cyan-500/30 transition-all duration-700 backdrop-blur-3xl overflow-hidden animate-in fade-in slide-in-from-bottom-12 duration-1000 fill-mode-both shadow-[0_40px_80px_-40px_rgba(0,0,0,1)]"
          ...
          >
            ...
            <div className="relative z-10 space-y-8">
              <div className="flex justify-between items-start">
                <h3 className="text-2xl lg:text-3xl font-black text-white uppercase tracking-[0.1em] leading-none group-hover:translate-x-2 transition-transform duration-500">
                  {pillar.title}
                </h3>
                <div className="text-right">
                  <div className="text-2xl font-black text-white group-hover:text-cyan-400 transition-colors duration-500">{pillar.stats}</div>
                  <div className="text-[7px] font-black text-zinc-700 uppercase tracking-widest">{pillar.label}</div>
                </div>
              </div>
              
              <p className="text-white text-sm font-semibold leading-relaxed opacity-70 group-hover:opacity-100 transition-opacity duration-500">
                {pillar.desc}
              </p>
      ...
      {/* Philosophy Section */}
      <div className="relative p-1 lg:p-px rounded-[4rem] bg-gradient-to-r from-transparent via-white/10 to-transparent mb-24 overflow-hidden group animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-700 fill-mode-both">
        <div className="bg-[#020202] rounded-[3.95rem] p-12 lg:p-24 flex flex-col lg:flex-row items-center gap-16 relative">
          {/* Subtle Scanline Overlay */}
          <div className="absolute inset-0 bg-scanline opacity-[0.02] pointer-events-none" />
          
          <div className="flex-1 space-y-8 relative z-10">
            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[0.15em] text-white leading-tight">
              WE DON'T BUILD CAMPAIGNS. <br />
              <span className="bg-clip-text text-transparent" style={{ backgroundImage: brandGradient }}>
                WE BUILD ARCHITECTURES.
              </span>
            </h2>
            <p className="text-zinc-500 text-sm md:text-base font-bold uppercase tracking-wide leading-relaxed">
            ...
            <div className="flex flex-wrap gap-8 pt-6">
              <div className="flex flex-col gap-1">
                <span className="text-2xl font-black text-white group-hover:text-cyan-400 transition-colors">99.9%</span>
                <span className="text-[8px] font-black text-zinc-700 uppercase tracking-widest">UPTIME RELIABILITY</span>
              </div>
              <div className="h-10 w-[1px] bg-white/10" />
              <div className="flex flex-col gap-1">
                <span className="text-2xl font-black text-white group-hover:text-purple-400 transition-colors">ZERO</span>
                <span className="text-[8px] font-black text-zinc-700 uppercase tracking-widest">TECHNICAL DEBT</span>
              </div>
            </div>
          </div>
          
          <div className="flex-1 w-full lg:w-auto flex justify-center relative">
            <div className="relative w-64 h-64 lg:w-80 lg:h-80 group-hover:scale-110 transition-transform duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)]">
               {/* Digital Matrix / Node Visual */}
               <div className="absolute inset-0 border border-white/5 rounded-[3rem] rotate-45 animate-pulse-slow" />
               <div className="absolute inset-4 border border-cyan-500/10 rounded-[2.5rem] -rotate-12 animate-pulse-slow delay-700" />
               <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-32 h-32 rounded-3xl bg-white flex flex-col items-center justify-center shadow-[0_0_80px_rgba(255,255,255,0.1)] relative group-hover:shadow-[0_0_100px_rgba(0,229,255,0.2)] transition-shadow duration-1000 overflow-hidden">
                     ...
                     <span className="text-black font-black text-5xl relative z-10">M</span>
                     <div className="w-8 h-[2px] bg-black/10 mt-1 rounded-full overflow-hidden">
